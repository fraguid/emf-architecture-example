...
public class CarsharingFactoryImpl extends EFactoryImpl implements CarsharingFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CarsharingPackage.USER: return createUser();
			case CarsharingPackage.VEHICLE: return createVehicle();
			case CarsharingPackage.RESERVATION: return createReservation();
			default:
